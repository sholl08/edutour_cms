...
const DestinasiAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await destinasiService.create(data);
      toast.success('Destinasi berhasil ditambahkan');
      navigate('/admin/destinasi');
    } catch (error) {
      toast.error(error.response?.data?.message || 'Gagal menambahkan destinasi');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-800">Tambah Destinasi</h1>
      </div>
